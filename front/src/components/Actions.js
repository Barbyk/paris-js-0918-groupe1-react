                ...
                <div class="container actioncontain" >
                    ...
                    <div class="action">
                        <div class="row">
                            ...
                            <div class='col-xs-12 col-md-6 col-lg-4'><a href="#logo"> <button class="bt" onClick={this.onClick6} ><img src={culture} alt="icon culture" title="culture et loisirs" class='actionlogo' /></button></a><h3>Culture et loisir</h3></div>

                            <div class='col-xs-12 col-md-6 col-lg-4'><a href="#logo"><button class="bt" onClick={this.onClick7} ><img src={soutient} alt="icon soutient" title="soutient scolaire" class='actionlogo' /></button></a><h3>Soutient scolaire</h3></div>
